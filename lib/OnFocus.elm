...
import Field.DateFocusInline as DateFocus
    ...
    Form.view Validate
      [ App.map UpdateTitle
          ( FieldGroup.view title
              (Input.viewSmall Field.blur title.value)
          )
      , App.map UpdateFirstName
          ( FieldGroup.view firstName
              (Input.view Field.blur firstName.value)
          )
      , App.map UpdateLastName
          ( FieldGroup.view lastName
              (Input.view Field.blur lastName.value)
          )
      , App.map UpdateCompanyName
          ( FieldGroup.view companyName
              (Input.view Field.blur companyName.value)
          )
